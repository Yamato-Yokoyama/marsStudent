...
class DefaultAppContainer : AppContainer {
    ...
    private val studentbaseUrl = "http://127.0.0.1:8000/api/students/"
    ...
    private val studentretrofit: Retrofit = Retrofit.Builder()
        .addConverterFactory(Json.asConverterFactory("application/json".toMediaType()))
    ...
    private val studentretrofitService: StudentApiService by lazy {
    ...
    override val studentRepository: StudentRepository by lazy {
        NetworkStudentRepository(studentretrofitService)
    }
}
